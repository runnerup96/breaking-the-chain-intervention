class TabFactIntervention:
    def __init__(self, dataset, llm_stop_token: str):
        ...
        Args:
            dataset: The TabFactDataset instance
    ...
    def make_prompt(self, sample: dict) -> str:
        ...
        Args:
            sample: Dictionary containing the TabFact sample data (table + statement)
            
        Returns:
            str: Formatted prompt for the LLM to reason about table factuality
        """
        pass
    ...
    def extract_target_from_prompt(self, generated_output):
        """
        Extract the final factuality prediction from the generated output.
        
        Args:
            generated_output: The LLM generation (could be dict or str)
            
        Returns:
            The extracted factuality prediction (True/False or 1/0)
        """
        pass
    ...
    def infer_completion(self, completion_output):
        ...
        Returns:
            The inferred factuality result (True/False or 1/0)
        """
        pass